...
from .views import CategoryViewSet, AreaViewSet, NewsViewSet, CommentViewSet, AdminRegisterView, LoginView, DistrictViewSet, UserRegisterView, AdminRegisterView, UserInfoView, LogoutView
